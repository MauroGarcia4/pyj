        ...
        <div className="bg-white p-8 rounded-lg shadow-sm space-y-6 text-gray-700">
          <section>
            ...
            <p>
              ...
              Si no está de acuerdo con alguna parte de estos términos, le pedimos que se abstenga de utilizar el sitio.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Todo el contenido de este sitio, incluidos textos, gráficos, logotipos e imágenes, es propiedad de Pedro & Juan y está protegido por las leyes de propiedad intelectual.
            </p>
          </section>
